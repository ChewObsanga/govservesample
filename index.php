...
<body class="bg-gray-50 font-sans">
    ...
    <section id="services" class="py-12 sm:py-16 md:py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h2 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl text-center">
                Our Services
            </h2>
            <p class="mt-4 max-w-2xl text-lg text-gray-500 lg:mx-auto text-center mb-8">
        ...
        <div id="chatWindow" class="hidden bg-white rounded-3xl shadow-2xl border border-gray-200 w-96 h-[500px] mb-4 overflow-hidden">
            ...
            <div id="chatMessages" class="pt-24 pb-6 px-6 h-96 overflow-y-auto bg-gray-50" style="scrollbar-width: thin; scrollbar-color: #d1d5db #f9fafb;">
                <div id="initialMessage" class="flex items-start space-x-3 mb-6" style="display: flex !important; visibility: visible !important; opacity: 1 !important; position: relative !important; z-index: 10 !important; margin-top: 4rem !important;">
                    <div class="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg" style="display: flex !important; align-items: center !important; justify-content: center !important; visibility: visible !important;">
            ...
            <div class="p-6 border-t-2 border-gray-300 bg-gray-50">
                <div class="flex space-x-3 items-center">
                    ...
                    <button onclick="sendMessage()" class="bg-green-500 hover:bg-green-600 text-white px-5 py-3 rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 min-w-[60px]">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4 lg:space-x-8 mb-4 sm:mb-6">
                    ...
                    <li class="flex items-center justify-center text-xs sm:text-sm"><span class="text-gray-400 mr-3">📧</span>Email: info@caloocancity.gov.ph</li>
            </div>
